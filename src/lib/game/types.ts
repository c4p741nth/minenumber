...
export interface PublicGameState {
  ...
  // optional เพราะ snapshot เก่า deserialize มาเป็น type นี้โดยไม่มี field นี้
  autoWireCut?: boolean
  // FIX_LISTS ชุดที่สิบห้า #2: กระดานอยู่ในรอบบังคับตัดสายแล้วหรือยัง
  //   (ช่องที่เหลือเป็นระเบิดจริงทั้งหมด) — รอบนี้ Shield ที่ค้างอยู่เป็นโมฆะ
  //   และกางใหม่ไม่ได้ ต่างจาก autoWireCut ที่ยังขึ้นกับการ์ดในมือของทีมที่เล่นอยู่
  // optional เพราะ snapshot เก่า deserialize มาเป็น type นี้โดยไม่มี field นี้
  forcedWireCut?: boolean
